...
\usepackage{placeins}
\usepackage{float}
\title{\textbf{Computational Analysis of Newtonian and Relativistic Gravitational Potentials: Error Quantification and Machine Learning Approximations}}
\hypersetup{
    colorlinks=true,
    linkcolor=blue,
    citecolor=blue,
...
The results demonstrate that machine learning models are capable of
reconstructing the underlying nonlinear structure of the relativistic
potential directly from sampled numerical data. Although the governing
equation is analytically known in the present study, the experiment
provides a controlled benchmark for evaluating how different machine
learning architectures capture physically meaningful relationships. Such
benchmark systems are valuable because they allow model performance to be
assessed against an exact theoretical solution before extending similar
techniques to more complex physical systems where analytical solutions may
not exist.
...
The present framework illustrates a broader principle in scientific
machine learning: machine learning models can serve as efficient
surrogate representations of computationally expensive physical models
while remaining grounded in established physical theory. This approach
is increasingly relevant in modern computational physics, where repeated
evaluation of complex systems can become computationally demanding.
